 ...
 * @version    Subversion: $Id: freemovement.php 278 2007-08-19 22:52:25Z ls $
...
final class Freemovement extends DpPage
{
    ...
    public function createDpPage()
    {
        ...
        $this->body =
            dp_text('This is an experiment with draggable objects.<br />
Try it for yourself!<br />
Others on the page see your movements.<br />');
        $this->setNavigationTrail(
            array(DPUNIVERSE_NAVLOGO, ''),
            array(dp_text('Showcases'), DPUNIVERSE_PAGE_PATH . 'showcases.php'),
            dp_text('Free Movement Demo'));
