<?php /* Smarty version 2.6.0, created on 2006-08-13 20:42:30
...
<div class="info-box">
	<br /><div class="info-box-title"><?php if ($this->_tpl_vars['is_interface']): ?>Interface<?php else: ?>Class<?php endif; ?> Overview</div>
	<div class="nav-bar">
		...
		<?php if ($this->_tpl_vars['ivars'] || $this->_tpl_vars['imethods']): ?>
			<a href="#sec-inherited">Inherits</a>
			<?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars'] || $this->_tpl_vars['methods'] || $this->_tpl_vars['imethods'] || $this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>|<?php endif; ?>
		<?php endif; ?>
		...
		<?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>
			<?php if ($this->_tpl_vars['methods']): ?>
				<a href="#sec-method-summary">Methods Summary</a> | <a href="#sec-methods">Methods Detail</a>
			<?php else: ?>
	...
	<div class="info-box-body">
		<table cellpadding="0" cellspacing="0" border="0" class="class-table">
		<tr><td valign="top" width="60%" class="class-overview">

        <?php if ($this->_tpl_vars['implements']): ?>
        <p class="implements">
            <span class="label-letter">IMPLEMENTS INTERFACES:</span>
            <ul>
...
unset($_smarty_tpl_vars);
 ?>
		...
		<?php if ($this->_tpl_vars['tutorial']): ?>
			<hr class="separator" />
			<div>Tutorial: <span class="tutorial"><?php echo $this->_tpl_vars['tutorial']; ?>
</div>
		<?php endif; ?>
...
<br />
        ...
        <table width="100%" border="0" cellspacing="2" cellpadding="2">
          <tr>
            <td width="1%" style="background-color: #eeeeee"><span class="label-letter">LOCATED&#160;IN:</span>&nbsp;&nbsp;</td><td width="99%" style="background-color: #eeeeee"><a href="<?php echo $this->_tpl_vars['page_link']; ?>
"><?php echo $this->_tpl_vars['source_location']; ?>
</a> [line <?php if ($this->_tpl_vars['class_slink']):  echo $this->_tpl_vars['class_slink'];  else:  echo $this->_tpl_vars['line_number'];  endif; ?>]</td>
          </tr>
		  <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
unset($_smarty_tpl_vars);
 ?>
		...
		<span class="label-letter">PROPERTIES:</span><br />
		<ul>
...
?>
		...
		<td valign="top" width="20%" class="class-overview">
		<span class="label-letter">METHODS:</span><br />
		<ul>
		  <?php if (isset($this->_sections['contents'])) unset($this->_sections['contents']);
$this->_sections['contents']['name'] = 'contents';
...
<?php if ($this->_tpl_vars['children']): ?>
	...
	<div class="info-box">
		<div class="info-box-title">Direct Descendants</div>
		<div class="nav-bar">
...
<?php if ($this->_tpl_vars['ivars'] || $this->_tpl_vars['imethods'] || $this->_tpl_vars['iconsts']): ?>
	...
	<div class="info-box">
		<div class="info-box-title">Inherits</div>
		<div class="nav-bar">
			<a href="#sec-description">Class Overview</a> |
			<?php if ($this->_tpl_vars['children']): ?>
				<a href="#sec-descendants">Descendants</a> |
			...
			<span class="disabled">Inherits</span>
			<?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars'] || $this->_tpl_vars['methods'] || $this->_tpl_vars['imethods'] || $this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>|<?php endif; ?>
			<?php if ($this->_tpl_vars['vars'] || $this->_tpl_vars['ivars']): ?>
				<?php if ($this->_tpl_vars['vars']): ?>
					<a href="#sec-var-summary">Properties Summary</a> | <a href="#sec-vars">Properties Detail</a>
...
?>
                    <br /><span class="label-letter">INHERITED FROM:</span>&nbsp; <span class="classname"><?php echo $this->_tpl_vars['iconsts'][$this->_sections['iconsts']['index']]['parent_class']; ?>
</span>
                    <dl>
...
?>
                    <br /><span class="label-letter">INHERITED FROM:</span>&nbsp; <span class="classname"><?php echo $this->_tpl_vars['ivars'][$this->_sections['ivars']['index']]['parent_class']; ?>
</span>
                    <dl>
...
?>
                    <br /><span class="label-letter">INHERITED FROM:</span>&nbsp; <span class="classname"><?php echo $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['parent_class']; ?>
</span><br />
...
?>
                        <?php if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['static']): ?>
                        <div class="method-definition">
                            <tr><td class="method-definition">static
                            <?php if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['function_return']): ?>
                                <span class="method-result"><?php echo $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['function_return']; ?>
</span>&nbsp;&nbsp;
                            <?php endif; ?></td>
                            <td class="method-definition"><b><?php echo $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['link']; ?>
</b>&nbsp;&nbsp;</td>
                            <td class="method-definition"><?php echo $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['sdesc']; ?>
</td></tr>
                        </div>
                        <?php endif; ?>
                    <?php endfor; endif; ?>
...
?>
                        ...
                        <div class="method-definition">
                            <?php if ($this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['function_return']): ?>
                                <tr><td class="method-definition"><span class="method-result"><?php echo $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['function_return']; ?>
</span>&nbsp;&nbsp;</td>
                            <?php endif; ?>
                            <td class="method-definition"><b><?php echo $this->_tpl_vars['imethods'][$this->_sections['imethods']['index']]['imethods'][$this->_sections['im2']['index']]['link']; ?>
</b>&nbsp;&nbsp;</td>
...
?>
			<?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['static']): ?>
				<div class="var-title">
					<tr><td class="var-title">static <span class="var-type-summary"><?php echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['var_type']; ?>
</span>&nbsp;&nbsp;</td>
...
<?php if ($this->_tpl_vars['methods']): ?>
	...
	<div class="info-box">
		<div class="info-box-title">Methods Summary</span></div>
		<div class="nav-bar">
			<a href="#sec-description">Class Overview</a> |
			<?php if ($this->_tpl_vars['children']): ?>
				<a href="#sec-descendants">Descendants</a> |
    		...
    		<?php if ($this->_tpl_vars['consts'] || $this->_tpl_vars['iconsts']): ?>
    			...
    			<?php endif; ?>
    		<?php endif; ?>
			<span class="disabled">Methods Summary</span> | <a href="#sec-methods">Methods Detail</a>
		</div><br clear="all" />
		<div class="info-box-body">
...
<?php if ($this->_tpl_vars['methods'] || $this->_tpl_vars['imethods']): ?>
	...
	<div class="info-box">
		...
		<div class="nav-bar">
			...
			<?php endif; ?>
			<?php if ($this->_tpl_vars['methods']): ?>
				| <a href="#sec-method-summary">Methods Summary</a> | <span class="disabled">Methods Detail</span>
			<?php else: ?>
