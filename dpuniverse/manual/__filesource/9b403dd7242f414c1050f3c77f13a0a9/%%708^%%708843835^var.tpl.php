<?php /* Smarty version 2.6.0, created on 2006-08-13 20:43:47
         compiled from var.tpl */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'var.tpl', 4, false),array('modifier', 'replace', 'var.tpl', 9, false),)), $this); ?>
...
</span><?php endif; ?>&nbsp;&nbsp;<span class="smalllinenumber">[line <?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink']):  echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['slink'];  else:  echo $this->_tpl_vars['vars'][$this->_sections['vars']['index']]['line_number'];  endif; ?>]</span>
		</span>
...
unset($_smarty_tpl_vars);
 ?>
        ...
        <?php if ($this->_tpl_vars['vars'][$this->_sections['vars']['index']]['descvar']): ?>
            <hr class="separator" />
            <div>Redefined in descendants as:</div>
