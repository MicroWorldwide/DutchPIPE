...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', 'classtags.tpl', 5, false),)), $this); ?>
...
:</span>&nbsp;&nbsp;</td><td width="99%" style="background-color: #eeeeee"><?php echo $this->_tpl_vars['api_tags'][$this->_sections['tag']['index']]['data']; ?>
</td>
  </tr>
...
<?php if (count ( $this->_tpl_vars['info_tags'] ) > 0): ?>
  <tr>
    <td style="background-color: #eeeeee"><span class="label-letter">AUTHOR(S):</span>&nbsp;&nbsp;</td>
...
$this->_sections['tag']['first']      = ($this->_sections['tag']['iteration'] == 1);
$this->_sections['tag']['last']       = ($this->_sections['tag']['iteration'] == $this->_sections['tag']['total']);
 if ($this->_tpl_vars['tags'][$this->_sections['tag']['index']]['keyword'] == 'author'): ?>
    <?php echo $this->_tpl_vars['tags'][$this->_sections['tag']['index']]['data'];  if (! $this->_sections['tag']['last']): ?>, <?php endif; ?>
...
?>
	<?php if ($this->_tpl_vars['info_tags'][$this->_sections['tag']['index']]['keyword'] != 'author'): ?>
		<tr><td width="1%" style="background-color: #eeeeee"><span class="label-letter"><?php echo ((is_array($_tmp=$this->_tpl_vars['info_tags'][$this->_sections['tag']['index']]['keyword'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
:</span>&nbsp;&nbsp;</td><td width="99%" style="background-color: #eeeeee"><?php echo $this->_tpl_vars['info_tags'][$this->_sections['tag']['index']]['data']; ?>
</td></tr>
