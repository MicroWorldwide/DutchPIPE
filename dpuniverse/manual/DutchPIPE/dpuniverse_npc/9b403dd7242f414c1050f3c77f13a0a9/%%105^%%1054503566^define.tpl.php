<?php /* Smarty version 2.6.0, created on 2006-08-13 20:44:01
...
<div class="evenrow">
	<div>
		<span class="const-title"><?php echo $this->_tpl_vars['defines'][$this->_sections['def']['index']]['define_name']; ?>
...
unset($_smarty_tpl_vars);
 ?>
        <?php if (count ( $this->_tpl_vars['defines'][$this->_sections['def']['index']]['api_tags'] ) > 0 || count ( $this->_tpl_vars['defines'][$this->_sections['def']['index']]['info_tags'] ) > 0): ?>
        <br />
