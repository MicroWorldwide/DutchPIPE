<?php /* Smarty version 2.6.0, created on 2006-08-13 20:42:32
...
?>
		<tr><td width="1%" style="background-color: #eeeeee"><span class="label-letter"><?php echo ((is_array($_tmp=$this->_tpl_vars['tags'][$this->_sections['tag']['index']]['keyword'])) ? $this->_run_mod_handler('upper', true, $_tmp) : smarty_modifier_upper($_tmp)); ?>
:</span>&nbsp;&nbsp;</td><td width="99%" style="background-color: #eeeeee"><?php echo $this->_tpl_vars['tags'][$this->_sections['tag']['index']]['data']; ?>
</td></tr>
	<?php endfor; endif; ?>
</table>
<?php endif; ?>