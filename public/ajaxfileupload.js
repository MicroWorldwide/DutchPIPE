...
var tmp = '<form action="" method="POST" name="' + formId
...
if (xml || isTimeout == "timeout") {requestDone = true;var status;
try {
...
jQuery(io).unbind();
setTimeout(function(){try {jQuery(io).remove();jQuery(form).remove();} catch(e) {jQuery.handleError(s, xml, null, e);}}, 100);xml = null;}};
