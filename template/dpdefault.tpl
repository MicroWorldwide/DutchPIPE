                ...
                <div style="position: relative; width: 100%">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                            ...
                            <td width="11"><div style="margin: 0px; float: right; width: 11px; padding-left: 6px"><img id="buttop" src="/images/top.gif" width="11" height="11" border="0" alt="<?php echo dptext('Go to Top') ?>" title="<?php echo dptext('Go to Top') ?>" onClick="_gel('action').focus(); setTimeout('gototop()', 10);" /></div><br clear="all" /></td>
                        </tr>
                    </table>
                </div>
            </div><br clear="all" />
