...
find . -name "*.php" -exec xgettext --no-location -L php --no-wrap -j -o locale/en/LC_MESSAGES/messages.po --keyword=dp_text {} \;
find . -name "*.tpl" -exec xgettext --no-location -L php --no-wrap -j -o locale/en/LC_MESSAGES/messages.po --keyword=dp_text {} \;
find . -name "*.php" -exec xgettext -L php --no-wrap -F -j -o locale/en/LC_MESSAGES/messages.po --keyword=dp_text {} \;
find . -name "*.tpl" -exec xgettext -L php --no-wrap -F -j -o locale/en/LC_MESSAGES/messages.po --keyword=dp_text {} \;
